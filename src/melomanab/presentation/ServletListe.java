...
public class ServletListe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.getWriter().append("Test liste chargée:" + !maListe.isEmpty() +"\n").append(request.getContextPath());


		// 3. --Elaborer reponse à envoyer au client
		// Pour passer la liste, il faut la rajouter comme attribut à la session 
